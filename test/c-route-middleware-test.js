...
// its important to attach autoReap before request processing?

app.route('/upload-single').post(autoReap, uploadHandler);
app.route('/upload-single').put(autoReap, uploadHandler);

app.route('/upload').post(autoReap, uploadHandler);
app.route('/upload').put(autoReap, uploadHandler);
...
describe('Multer Autoreap (route middleware)', function() {
